    ...
    <div class="bg-white border rounded-lg shadow-md dark:bg-gray-800 dark:border-gray-700">
        <div class="bg-gray-100 dark:bg-gray-900">
            <div class="container mx-auto px-4 py-8 dark:text-gray-400">
                <h1 class="text-3xl font-bold mb-4 dark:text-gray-200" align="center">Privacy Policy for Sob Offer</h1>

                <br>
                <p class="mb-4">
                    Sob Offer provides the app as a free service. This service is offered by Sob Offer at no charge
                    and is intended for use as it is.
                </p>
                ...
                <p class="mb-4">
                    ...
                    employ or distribute your information to any party except as detailed in this Privacy Policy.By utilizing
                    our Service, you consent to the gathering and utilization of information as outlined in this policy. The
                    Personal Information we gather is employed to enhance and provide the Service. We pledge not to employ or
                    distribute your information to any party except as detailed in this Privacy Policy.
                </p>

                <p class="mb-4">
                    The terms mentioned in this Privacy Policy have the same meanings as those detailed in our Terms and
                    Conditions, accessible on the Sob Offer platform, unless explicitly defined differently in this Privacy
                    Policy.
                </p>

                <h2 class="text-2xl font-bold mb-2 dark:text-gray-300">Information Collection and Use</h2>
                ...
                <ul class="list-disc list-inside mb-4">
                    <li><a style="color:blue" href="https://www.google.com/policies/privacy/">Google Play Services</a></li>
                    <li><a style="color:blue" href="https://support.google.com/admob/answer/6128543?hl=en">Admob</a></li>
                    <li><a style="color:blue" href="https://firebase.google.com/support/privacy/">Firebase</a></li>
                    <li><a style="color:blue" href="https://unity3d.com/legal/privacy-policy">Unity</a></li>
                </ul>

                <h2 class="text-2xl font-bold mb-2 dark:text-gray-300">Log Data</h2>
                ...
                <h2 class="text-2xl font-bold mb-2 dark:text-gray-300">Cookies</h2>
                ...
                <h2 class="text-2xl font-bold mb-2 dark:text-gray-300">Service Providers</h2>
                ...
                <h2 class="text-2xl font-bold mb-2 dark:text-gray-300">Children's Privacy</h2>
                ...
                <h2 class="text-2xl font-bold mb-2 dark:text-gray-300">Changes to This Privacy Policy</h2>
                ...
                <p class="mb-4">
                    This policy is effective as of April 15, 2025.
                </p>
